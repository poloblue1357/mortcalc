...
function CampaignsdisplayL(props) {
    ...
    return (
        <div style={{border: "2px black solid", padding: "5px", margin: "10px", display: "flex", justifyContent: "center", alignItems: "center", width: "200px"}}>
            ...
            <button style={{margin: "1px", height: "20px"}} onClick={() => context.deleteCampaignsL(props.c1._id)}>Delete</button>
...
export default CampaignsdisplayL