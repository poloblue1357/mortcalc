...
function AmortizationTablesBetter(props) {
...
function countOne() {
    ...
    return (
        <div class="currentContainer">
            <p class="number" style={{display: "flex", justifyContent: "center", alignItems: "center", verticalAlign: "middle", paddingTop: '1.5px'}}>{props.j+1}</p>
...
export default AmortizationTablesBetter