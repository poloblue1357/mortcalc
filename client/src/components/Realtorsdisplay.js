            ...
            {isEdit ? 
                <div>
                    <form onSubmit={(event) => {
                        ...
                        <input placeholder="First Name" type="text" name="firstName" value={context.firstName} onChange={handleChange} value={editedRealtor.firstName} style={{backgroundColor: "lightblue"}}/>
                        <input placeholder="Last Name" type="text" name="lastName" value={context.lastName} onChange={handleChange} value={editedRealtor.lastName} style={{backgroundColor: "lightblue"}}/>
