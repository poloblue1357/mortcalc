...
function AmortizationTablesGood(props) {
...
function countOne() {
    ...
    return (
        <div class="currentContainer">
            <p class="number" style={{display: "flex", justifyContent: "center", alignItems: "center", verticalAlign: "middle", paddingTop: '1.5px'}}>{props.k+1}</p>
  ...
  maximumFractionDigits: 2})}</td>
                        <td class="tableNumber" style={{flex: .5, textAlign: "center", width: "60px", padding: "4px 0px"}}>${props.info?.MI}</td>
                        <td class="tableNumber" style={{flex: .75, textAlign: "center", width: "60px", padding: "4px 0px"}}>{props.info.extra}</td>
                    </tr>
                    {/* <div class="rightMap" style={{backgroundColor: "#334960"}}></div> */}
                {/* </tbody>
            </table> */}
            {/* <br /> */}
        </div>
...
export default AmortizationTablesGood